// Verbatim reference copy of WalletWasabi/Crypto/OwnershipIdentifier.cs
// (WalletWasabi @ NBitcoin 10.0.7). Kept here so the interop suite can assert
// the native ownership proof is byte-for-byte compatible with WalletWasabi's
// managed OwnershipProof. Do not "improve" — it must mirror the source of truth.
using NBitcoin;
