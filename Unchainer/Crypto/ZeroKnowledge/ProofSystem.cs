namespace Unchainer.Crypto.ZeroKnowledge;
...
internal partial class ProofSystem
{
	...
	public static IEnumerable<Proof> Prove(Transcript transcript, IEnumerable<Knowledge> knowledge, UnchainexRandom random)
	{
	...
	// expect nonce provider instead of UnchainexRandom?
	public static (Knowledge knowledge, IEnumerable<GroupElement> bitCommitments) RangeProofKnowledge(Scalar a, Scalar r, int width, UnchainexRandom rnd)
	{
