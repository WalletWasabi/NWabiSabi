...
public sealed class Transcript
{
	...
	public Transcript(byte[] label)
		: this(new Strobe128(ProtocolConstants.UnchainerProtocolIdentifier))
	{
	...
	public SyntheticSecretNonceProvider CreateSyntheticSecretNonceProvider(IEnumerable<Scalar> secrets, UnchainexRandom random)
