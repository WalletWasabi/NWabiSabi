...
using System.Text;
using Unchainer.Crypto.StrobeProtocol;
using Unchainer.Helpers;
...
public class Strobe128Tests
{
	...
	public void BehaiorIsDeterministic()
	{
		...
		strobe1.AddAssociatedMetaData(ToBytes("unchainer://unitests/"), false);
		strobe1.AddAssociatedMetaData(ToBytes("greeting/"), true);
		strobe1.AddAssociatedData(ToBytes("hello"), false);

		strobe2.AddAssociatedMetaData(ToBytes("unchainer://unitests/"), false);
	...
	{
		var testVectorFile = File.ReadAllText("./Data/StrobeTestVectors.json");
